                ...
                <div className='grid grid-cols-1 justify-items-center content-center h-screen '>
                    <div className='min-w-[540px] min-h-[611px] px-16 py-12 bg-white rounded-3xl'>
                        <div className='text-center'>
                            ...
                            <h1 className='font-bold text-4xl leading-[46px] font-primary mt-6'>Let’s Log You In</h1>
                        </div>
                        ...
                        <div className='flex flex-col justify-center mt-12'>
                            ...
                            <button onClick={() => handleLogIn()} className='mt-10 py-4 font-bold font-primary text-base leading-6 bg-[#FFDDA9] rounded-full hover:bg-[#f0cc99]'>Log In</button>
                        </div>
                        <div className='border border-[#E7E5EA] mt-10 mb-10'></div>
                        <div className='text-center'>
                            <p className='font-bold text-base font-primary text-[#594D6D] leading-6'>Don't have an account?<span className='text-[#391484]'> Log In</span></p>
                        </div>
                    </div>
                </div>
            </div>
